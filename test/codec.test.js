...
const fee = new IRIS.Coin('iris-atto', '600000000000000000')
...
describe('codec', () => {
  it('encode MsgSend', () => {
    const receipt = new IRIS.AccAddress([134, 152, 80, 35, 135, 38, 124, 211, 158, 176, 61, 130, 76, 234, 166, 214, 133, 57, 181, 7])
    ...
    const sequence = 57
    const msg = IRIS.MsgSend.create(sender, receipt, [new IRIS.Coin('iris-atto', '10000000000000000000')])
  ...
  it('encode MsgDelegate', () => {
    const validator = new IRIS.AccAddress([239, 109, 152, 243, 114, 255, 194, 210, 230, 20, 108, 65, 177, 146, 185, 70, 39, 151, 164, 253])
    const signature = new IRIS.AccAddress([193, 24, 243, 215, 239, 140, 54, 246, 94, 208, 225, 111, 23, 28, 148, 226, 15, 83, 253, 86, 85, 156, 86, 157, 118, 116, 34, 229, 72, 180, 89, 133, 56, 242, 105, 189, 30, 54, 110, 109, 44, 0, 200, 193, 40, 189, 10, 131, 197, 207, 219, 203, 158, 179, 89, 87, 228, 196, 225, 75, 138, 41, 90, 230])
    const sequence = 12
    const msg = IRIS.MsgDelegate.create(sender, validator, new IRIS.Coin('iris-atto', '1000000000000000000000000'))
    console.log(JSON.stringify(msg.getSignBytes()))
  ...
  it('decode MsgWithdrawDelegatorRewardsAll', () => {
  ...
  it('decode MsgWithdrawDelegatorReward', () => {
