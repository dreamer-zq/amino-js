...
const pub_key = new Type.PubKeySecp256k1([235, 90, 233, 135, 33, 3, 128, 234, 6, 23, 16, 160, 236, 237, 58, 91, 222, 102, 37, 248, 194, 84, 147, 67, 253, 21, 94, 208, 251, 92, 39, 91, 77, 163, 146, 76, 185, 81])
...
describe('codec', () => {
  it('encode MsgSend', () => {
    ...
    const signature = new Type.SignatureSecp256k1([156, 11, 125, 181, 8, 234, 122, 109, 230, 27, 184, 196, 197, 212, 169, 207, 205, 83, 32, 139, 91, 147, 17, 87, 9, 58, 105, 173, 211, 177, 197, 155, 26, 212, 250, 0, 80, 102, 73, 14, 235, 68, 74, 28, 149, 51, 127, 182, 66, 222, 200, 153, 11, 91, 101, 37, 19, 138, 139, 79, 148, 47, 191, 147])
    const sequence = 57
